...
<html lang="es">
  <head>
   ...
   <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
    <META NAME="Title" content="ADMINISTRADORA VATELL">
    <META NAME="Author" CONTENT="[http://vatell.net/]"/>
...
<section class="seccion1" id="NOSOTROS">
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
          <h1 class="text-center text-danger text-dise-nosotros">ADMINISTRADORA VATELL</h1>
          <p class="lead text-center textt-nosotros">Somos uno mas de tu equipo de trabajo</p>
          <p class="lead text-center text-nosotros">Nuestros clientes son muy valiosos, entendemos a la perfección el desarrollo constante de una empresa. Nuestro trabajo es facilitar el cumplimiento de las actividades contables, fiscales administrativas y financieras para lograr el equilibrio optimo que permita un crecimiento constante.</p>
        </div>
      </div>
  ...
  <div style="text-align: center; margin-top: 5%;">
   ...
   <figure class="banner2">
    <p class="text-banner">AVANZANDO JUNTOS, CONSULTA CON NOSOTROS</p>
  </figure>
</section>
      ...
      <div class="row">
       ...
       <div class="row margen-arriba">
          ...
          <div class="col-xs-12 col-sm-4 col-md-4">
            ...
            <h3 class="text-center text-subtit">SERVICIOS FISCALES</h3>
            <p class="text-center">Determinación de las contribuciones fiscales de acuerdo a las disposiciones fiscales vigentes.</p>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
          ...
          <div class="col-sm-6 col-md-3 br-contacto">
            ...
            <p class="text-center">C. San Borja #1208 por C. Yucatas y C. Cuauhtemoc Col. Navarrete, Benito Juarez, México. C.P.03020.
            </p>
          </div>
        </div> <br><br>
    </div>
...
<footer>
<p>Derechos de autor 2017 © | ADMINISTRADORA VATELL S.C.P </p>
</footer>
